...
half4 Ripple(
     ...
     // Instead of just brightening, tint with lime color
     half3 limeColor = half3(133.0/255.0, 252.0/255.0, 30.0/255.0);
     color.rgb += (rippleAmount / amplitude) * limeColor * color.a;
